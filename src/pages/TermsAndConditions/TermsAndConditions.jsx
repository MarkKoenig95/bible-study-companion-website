  ...
  return (
    <div>
      ...
      <div className="indented">
        ...
        <p>
          Bible Study Companion is licensed to You (End-User) by Human App Maker
        ...
        <p>
          ...
          liability, maintenance and support thereof. Human App Maker, not
        ...
        <p>
          ...
          . Human App Maker acknowledges that it had the opportunity to review
...
function Section1() {
  return (
    <div>
      ...
      <div className="indented">
        <p>
          Bible Study Companion (hereinafter: Application) is a piece of
          software created to Assisting in maintaining a Bible reading schedule
          and study habits. - and customized for Apple mobile devices. It is
          used to Aid Bible study.
        </p>
        <p>
    ...
    <div>
      ...
      <div className="indented">
        <p>
          ...
          on any Apple-branded Products that You (End-User) own or control and
          as permitted by the Usage Rules set forth in this section and the App
        ...
        <p>
          ...
          Conditions, and with Human App Maker's prior written consent), sell,
        ...
        <p>
          ...
          Application, or any part thereof (except with Human App Maker's prior
          written consent).
        </p>
        <p>
  ...
  return (
    <div>
      ...
      <div className="indented">
        ...
        <p>
          4.2  Human App Maker and the End-User acknowledge that Apple has no
    ...
    <div>
      ...
      <div className="indented">
        <p>
          ...
          <a
            href="http://www.biblesc.com/privacy"
            target="_blank"
            rel="noopener noreferrer"
            data-custom-class="link"
          >
            http://www.biblesc.com/privacy
          </a>
          .
        </p>
      </div>
...
function Section6() {
  return (
    <div>
      ...
      <div className="indented">
        <p>
          The Application does not offer users to submit or post content. We may
  ...
  return (
    <div>
      ...
      <div className="indented">
        ...
        <p>
          By submitting suggestions of other feedback regarding the Application,
    ...
    <div>
      ...
      <div className="indented">
        ...
        <p>
          ...
          in case of alterations or manipulations of the Application, You will
          not have access to licensed Application.
        </p>
      </div>
    </div>
  );
    ...
    <div>
      ...
      <div className="indented">
        ...
        <p>
          ...
          there are any other reasons outside of Human App Maker's sphere of
        ...
        <p>
          ...
          installing it and notify Human App Maker about issues discovered
        ...
        <p>
          9.4  If we confirm that the Application is defective, Human App Maker
...
function Section10() {
  return (
    <div>
      ...
      <div className="indented">
        <p>
          Human App Maker and the End-User acknowledge that Human App Maker, and
...
function Section13() {
  return (
    <div>
      ...
      <div className="indented">
        <p>
          The license is valid until terminated by Human App Maker or by You.
          Your rights under this license will terminate automatically and
          without notice from Human App Maker if You fail to adhere to any
...
function Section14() {
  return (
    <div>
      ...
      <div className="indented">
        <p>
          Human App Maker represents and warrants that Human App Maker will
...
function Section15() {
  return (
    <div>
      ...
      <div className="indented">
        <p>
          Human App Maker and the End-User acknowledge that, in the event of any
          ...
          party's intellectual property rights, Human App Maker, and not Apple,
    ...
    <div>
      ...
      <div className="indented">
        ...
        <p>
          ...
          writing. These terms of use were created using
